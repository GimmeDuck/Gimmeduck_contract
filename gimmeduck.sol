...
contract KIP17GimmeDuck is KIP17, KIP17Enumerable, KIP17Metadata, MinterRole {
   ...
   // bool public publicMintEnabled = false;
    ...
    function withdraw() external onlyMinter{
      ...
      // =============================================================================
      0x38596eD0dceaC58632bCf8BD92B5af3854d6A768.transfer(address(this).balance);
      // =============================================================================
    }

    function mintingInformation() external view returns (uint256[4] memory){
...
//5 1 1000 1000000000000000000
    ...
    //Public Mint
    function publicMint(address user) external payable {
